  ...
  return (
    ...
    >
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        <Grid item xs={0.5} sx={{ borderRight: "1px solid #000",display: "flex",
            justifyContent: "center",
        ...
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
            alignItems: 'center',width:"100%",px:"5px",height: "auto",
        ...
        <Grid item xs={2} sx={{ borderRight: "1px solid #000" }}>
          <Typography component="span" sx={{ fontStyle: "uppercase",display:'flex',
            ...
            alignItems: 'center', px:"5px",height: "auto",
            overflowWrap: "break-word",
            wordBreak: "break-all",}}>
            1
          </Typography>
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>140</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
            alignItems: 'center',width:"100%",px:"5px",height: "auto",
            overflowWrap: "break-word",
            wordBreak: "break-all",fontWeight:"bold",}}>
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>240</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000", }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>250</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>260</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>290</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>300</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>330</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>340</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>350</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>380</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>390</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>410</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>430</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>440</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000", }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>450</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      {/* 470 */}
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>470</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>480</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      {/* 490 */}
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>490</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      {/* 500 */}
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>500</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>510</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>520</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>530</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>550</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000", }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>560</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000" }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center", }}>570</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
      ...
      <Grid container sx={{ borderBottom: "1px solid #000",bgcolor:Colors.blue_light_ultra }}>
        ...
        <Typography sx={{ display: "flex",
            justifyContent: "center",
            alignItems: "center",fontWeight:"bold", }}>580</Typography>
        </Grid>
        <Grid item xs={3.5} sx={{ borderRight: "1px solid #000" }}>
        <Typography component="span" sx={{ fontStyle: "uppercase" ,display: 'flex',
            justifyContent: 'flex-start',
