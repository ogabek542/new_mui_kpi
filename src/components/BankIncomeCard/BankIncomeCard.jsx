...
import VerticalBarchartTwo from "../VerticalBarchartTwo/VerticalBarchartTwo";
...
const BankIncomeCard = ({
    title,
    titleone,
    titletwo,
    percentageTitle,
    nopercentageIncomeTitle,
    totalIncomes,
    totalIncomesPercentage,
    percentageIncome,
    nopercentageIncome,
    percentageIncomePercentage,
    nopercentageIncomePercentage,
    onButtonClick,
    buttonText,
}) => {
        ...
        >
          ...
          >
            ...
            >
                ...
                <VerticalBarchartTwo
                percentageIncome={percentageIncomePercentage || 0}
                nopercentageIncome={nopercentageIncomePercentage || 0}
              />
            </Box>
            {/* right side Texts */}
            <Box sx={{}}>
                ...
                <Box>
                  ...
                  >
                    ...
                    >
                      ...
                      {insertSpaces(percentageIncome || 0)}
                    </Typography>
                    <Typography
                      sx={{
                        color: Colors.gray,
                ...
                <Box>
                  ...
                  >
                    ...
                    >
                      ...
                      {insertSpaces(nopercentageIncome || 0)}
                    </Typography>
                    <Typography
                      sx={{
                        color: Colors.gray,
