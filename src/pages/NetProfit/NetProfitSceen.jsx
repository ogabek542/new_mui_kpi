                    ...
                    <Box key={idx} sx={{ width: "100%", height: "100%" }}>
                      ...
                      <Box sx={{ width: "100%", height: "50%" }} >
                            ...
                            <Box sx={{ width: "100%", height: "350px" }}>
                              {/* Make sure the planData and factData are defined */}
                              <NoIncomeLineChart
                      ...
                      <Box sx={{ width: "100%", height: "50%" }} >
                            ...
                            <Box sx={{ width: "100%", height: "350px" }}>
                              {/* Make sure the planData and factData are defined */}
                              <NewLineChart
                                planData={divideAndRoundData(sanaItem.interestIncome?.planData || [])}
                                factData={divideAndRoundData(sanaItem.interestIncome?.factData || [])}
                              />
                            </Box>
                          </Box>
