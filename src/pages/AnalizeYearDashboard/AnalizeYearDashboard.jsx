...
const AnalizeYearDashboard = () => {
  ...
  const getSelectedParams = () => {
    ...
    // Filials
    params.filials = checkedItems.length ? checkedItems : ["Respublika"]; // If no filials selected, send all filial names
  ...
  const toggleColumnVisibility = (columnKey) => {
    setVisibleColumns((prev) => {
      ...
      const visibleCount =
        Object.values(updatedVisibility).filter(Boolean).length;
  ...
  const sendCheckedItemsToBackend = async () => {
    ...
    try {
      ...
      if (selectedYears.length === 1) {
        ...
        setFirstTableData(response.data); // Update firsttableData directly
      ...
      >
        ...
        >
          ...
          {uiType === "1-UI" && tableData && (
            <Box
              sx={{ minWidth: "4000px", whiteSpace: "nowrap", height: "100%" }}
            >
                    ...
                    >
                      ...
                      {firsttableData.newMonths.map((month) => (
                        <TableCell
                          key={month}
                          colSpan={
                            showFirstYear ? 4 : 3 || showSecondYear ? 3 : 2
                          }
                          sx={{
                            textAlign: "center",
                            width: "320px",
                          ...
                          >
                            <Button
                              ...
                              sx={{
                                ...
                                color: "black",
                                borderRadius: "0px",
                                bgcolor: visibleColumns.firstYear
                                  ? "#66CFFF"
                                  : "#C0C0C0", // Light blue when visible, dark blue when hidden
                                "&:hover": {
                                  bgcolor: visibleColumns.firstYear
                                    ? "#559FCF"
                                    : "#9CC5D2", // Adjust hover color
                                },
                              }}
                              onClick={() =>
                                toggleColumnVisibility("firstYear")
                              }
                            >
                              {firstYear}
                            </Button>
                            <Button
                              ...
                              sx={{
                                ...
                                color: "black",
                                borderRadius: "0px",
                                bgcolor: visibleColumns.secondYear
                                  ? "#66CFFF"
                                  : "#C0C0C0",
                                "&:hover": {
                                  bgcolor: visibleColumns.secondYear
                              ...
                              onClick={() =>
                                toggleColumnVisibility("secondYear")
                              }
                            >
                              {secondYear}
                            </Button>
                            <Button
                              ...
                              sx={{
                                ...
                                color: "black",
                                borderRadius: "0px",
                                bgcolor: visibleColumns.percentage
                                  ? "#66CFFF"
                                  : "#C0C0C0",
                                "&:hover": {
                                  bgcolor: visibleColumns.percentage
                              ...
                              onClick={() =>
                                toggleColumnVisibility("percentage")
                              }
                            >
                              %
                            </Button>
                        ...
                        {firsttableData &&
                          ...
                          firsttableData.data.map((row) => (
                            <DataRow
                              key={row.id}
                              row={row}
                              monthArray={firsttableData.newMonths}
                            />
                          ))}
                        {/* <==== TOTAL BOTTOM SECTION  ====> */}
